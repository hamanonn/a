...
import { Home, History, Camera, LogOut } from 'lucide-react';
import { useAuth } from '../contexts/AuthContext';

interface NavigationProps {
  currentView: 'dashboard' | 'history' | 'scanner';
  onViewChange: (view: 'dashboard' | 'history' | 'scanner') => void;
}
        ...
        <div className="max-w-md mx-auto">
          <div className="flex items-center justify-around">
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center py-2 px-3 rounded-lg transition-all ${
                    isActive 
                      ? `${item.color} bg-opacity-10 bg-current`
            ...
            <button
              ...
              className="flex flex-col items-center py-2 px-3 rounded-lg text-red-400 hover:text-red-600 transition-colors"
            >
